...
page('/:slug', function(context) {
    ...
    // var isFirstPage = document.querySelector('#lorem1');

    // if (isFirstPage) {
    //     isFirstPage = false;
    //     return newPage.querySelector('h2').focus();;
    // }

    // this will move the focus to the first heading once a new page is loaded
